...
def _main() :
    ...
    if args.TASK == 'vasp':
        ...
        make_deepmd_lammps(jdata, args.CONF, args.MAX_MILLER, static = False, relax_box = args.relax_box, task_name = args.TASK)
    elif args.TASK == 'deepmd-static' :
        make_deepmd_lammps(jdata, args.CONF, args.MAX_MILLER, static = True, relax_box = args.relax_box, task_name = args.TASK)
    elif args.TASK == 'meam' :
        make_meam_lammps(jdata, args.CONF, args.MAX_MILLER, static = False, relax_box = args.relax_box, task_name = args.TASK)
    elif args.TASK == 'meam-static' :
        make_meam_lammps(jdata, args.CONF, args.MAX_MILLER, static = True, relax_box = args.relax_box, task_name = args.TASK)
    else :
