...
def init_bulk_jdata_arginfo() -> Argument:
    ...
    doc_pert_numb = "Number of perturbations for each POSCAR."
    doc_pert_box = "Percentage of Perturbation for cells."
...
def init_surf_jdata_arginfo() -> Argument:
    ...
    doc_vacuum_numb = "Number of vacuum. **Necessary** if vacuum_resol is empty."
    doc_mid_point = "Value of mid-point. **Necessary** if the size of vacuum_resol is 2 or 0."
    doc_head_ratio  = "Ratio of head. **Necessary** if vacuum_resol is empty."
