...
def model_devi_jobs_args() -> List[Argument]:
    ...
    doc_nsteps = 'Running steps of MD. It is not optional optional when not using template.'
    doc_ensemble = 'Determining which ensemble used in MD, options include “npt” and “nvt”. It is not optional when not using template.'
