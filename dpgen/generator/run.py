...
def make_train(iter_index, jdata, mdata):
    ...
    training_init_frozen_model = iter_index == 0 and jdata.get("training_init_frozen_model")
    training_finetune_model = iter_index == 0 and jdata.get("training_finetune_model")
