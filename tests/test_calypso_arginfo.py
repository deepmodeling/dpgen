...
class TestCalypsoArginfo(unittest.TestCase):
    def test_legacy_selection_keys_remain_accepted(self):
        """Merging shared metadata must preserve the PR's accepted input keys."""
        data = {
            "model_devi_engine": "calypso",
            **self.selection,
            "model_devi_jobs": [],
            "calypso_input_path": "calypso_input",
            "model_devi_e_trust_lo": 0.1,
            "model_devi_e_trust_hi": 0.3,
            "model_devi_f_avg_relative": False,
            "use_relative": False,
            "epsilon": 0.1,
            "use_relative_v": False,
            "epsilon_v": 0.1,
        }
