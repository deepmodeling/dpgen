...
ref_cp2k_file_input = './tests/generator/cp2k_make_fp_files/input/test_ref.inp'
ref_cp2k_file_exinput = './tests/generator/cp2k_make_fp_files/exinput/test_ref.inp'
